...
data class BookshelfEntity(
    ...
    @ColumnInfo(name = BOOKSHELVES_DESCRIPTION_COLUMN, defaultValue = "NULL") var description: String?,
    @ColumnInfo(name = BOOKSHELVES_SELF_LINK_COLUMN, defaultValue = "NULL") var selfLink: String?,
